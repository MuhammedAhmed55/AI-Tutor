      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className='max-h-[65vh]'>
          ...
          <CommandGroup
            ...
            className='[&_[cmdk-group-heading]]:text-muted-foreground !px-4 !py-6 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-normal [&_[cmdk-group-heading]]:uppercase w-[500px]'
          >
